...
describe 'Wiki::Page' do
  ...
  it 'write content' do
    ...
    page.write('new content', 'comment2', Wiki::User.new('Author2', 'author2@localhorst'))

    page.commit.message.should.equal 'comment2'
  ...
  it 'fail on duplicates' do
    page = Wiki::Page.new(@repo, 'test')
    page.write('content', 'comment', Wiki::User.new('Author', 'author@localhorst'))
